...
plot2DGraph <- function(seqs, genbank = FALSE, xlab = 'X', ylab = 'Y', main = '',
                        colorset = c('#ff6361', '#58508d', '#ffa600', '#bc5090', '#003f5c'),
  ...
  palette <- adjustcolor(colorset[graphs_shuffled$nr], alpha.f = 0.3)

  par(family = 'HersheySerif')
  plot(graphs_shuffled$X, graphs_shuffled$Y, col = palette, pch = 16,
